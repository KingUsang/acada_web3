...
export default function TutorHomePage() {
  ...
  return (
    <div className="bg-background font-body text-on-surface selection:bg-primary-container min-h-screen">
      <header className="fixed top-0 w-full z-50 bg-surface-container-lowest/80 backdrop-blur-xl shadow-[0_16px_32px_-4px_rgba(7,14,29,0.04)]">
      ...
      <main className="pt-24 pb-32 px-6 max-w-7xl mx-auto space-y-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container-highest p-8 rounded-xl flex flex-col justify-between h-48 shadow-sm">
            <div className="flex justify-between items-start">
              <span className="material-symbols-outlined text-primary-container text-3xl">
                auto_stories
              </span>
              <span className="font-label text-xs font-bold text-on-surface bg-primary-container px-2 py-1 rounded-full">
                Active
              </span>
            </div>
            <div>
              ...
              <p className="text-5xl font-headline font-bold text-on-surface tracking-tighter">
          ...
          <section className="space-y-6">
            ...
            <div className="bg-surface-container-high rounded-xl p-6 relative overflow-hidden shadow-sm">
              <div className="relative z-10">
                ...
                <Link
                  href="/create_course"
                  className="w-full py-4 bg-primary text-on-primary rounded-xl font-label text-sm font-bold tracking-widest hover:bg-primary-dim transition-colors uppercase flex items-center justify-center"
                >
                  Launch Builder
                </Link>
              </div>

...
export default function SignUpPage() {
  ...
  return (
    <div className="bg-background font-body text-on-background min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      <main className="w-full max-w-120 z-10">
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex p-1 bg-surface-container-high rounded-full w-full">
                ...
                <button 
                  ...
                  className={`flex-1 py-3 px-6 rounded-full font-label font-semibold text-sm transition-all duration-200 ${role === "STUDENT" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:text-on-surface"}`}
                >
                  Student
                </button>
                {/* Tutor Pill */}
                <button 
                  ...
                  className={`flex-1 py-3 px-6 rounded-full font-label font-semibold text-sm transition-all duration-200 ${role === "TUTOR" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:text-on-surface"}`}
                >
                  Tutor
                </button>
              </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <div className="pt-4">
                <button 
                  type="submit" 
                  className="w-full py-5 rounded-xl bg-linear-to-br from-primary to-primary-dim text-on-primary font-headline font-extrabold text-lg tracking-tight shadow-lg shadow-primary/20 active:scale-[0.98] transition-all duration-200 flex items-center justify-center space-x-3 disabled:opacity-50"
      ...
      <div className="hidden lg:block fixed right-16 top-1/2 -translate-y-1/2 w-100 space-y-6">
        {/* Feature Card 1 */}
        ...
        {/* Feature Card 2 */}
        <div className="bg-surface-container-lowest/80 backdrop-blur-xl p-6 rounded-xl shadow-sm space-y-4">

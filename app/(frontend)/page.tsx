      ...
      <main className="relative flex min-h-screen flex-col items-center overflow-x-hidden pt-16 pb-28">
        ...
        <section className="w-full max-w-7xl px-6 pb-14">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
            ...
            <div className="rounded-xl bg-surface-container-highest p-8 text-center md:col-span-4">
              <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-surface-container-lowest mx-auto">
            ...
            <div className="rounded-xl bg-primary p-8 text-on-primary md:col-span-4">

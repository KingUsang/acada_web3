      ...
      <main className="w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-8 shadow-[0_16px_32px_-4px_rgba(7,14,29,0.04)]">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  className="block w-full pl-11 pr-4 py-4 bg-surface-container-low border-none rounded-xl text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary focus:bg-surface-container-highest transition-all duration-200 font-body" 
                  id="email" 
                  name="email" 
          ...
          <button 
            ...
            disabled={isLoggingIn}
          >
            <svg className="w-5 h-5 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="mt-8 text-center text-on-surface-variant font-medium">
          ...
          <Link className="text-primary font-bold hover:underline" href="/sign_up">Sign up for free</Link>
        </p>
      </main>
    </div>
  );
